...
Figure 4.1 below shows the transition functions represented with DBN and CPT with a specific action.
<img src="images/transition-representation.png" width = "80%" height = "80%" />

Figure 4.3 below shows the transition functions represented with CPT and DT with a specific action.
